...
def help():
    print('')
    print('============== HELP ================')
    print('This simple script generates a word, which you can use')
    print('as an unique login or password. Inputs requie two words.')
    print('First word is an array of atributes, that will rule')
    print("the result's strength. Second word - is result's length.")
